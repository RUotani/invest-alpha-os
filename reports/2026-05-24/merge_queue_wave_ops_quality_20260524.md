<<< COPY FROM HERE >>>
# Merge Queue — wave_ops_quality_20260524
...
- New CLI: `log evidence-manifest` (read-only manifest writer to reports/).
- No live HTTP / cache write / Gmail / default changes.
- Agent must not label MERGE; ChatGPT fills MERGE / REBASE_FIRST / REVIEW_REQUIRED / DO_NOT_MERGE.
