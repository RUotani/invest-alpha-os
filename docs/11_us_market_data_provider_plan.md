# US equities / ETFs — market data provider plan (Main R2–Main R5.1)
...
| **Beyond Main R5.1** | Scheduled multi-symbol ingest at scale, Alpha Vantage commercial path, richer mapping — backlog (**R6+**). |
